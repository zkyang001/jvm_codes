...
public class TestCode16_Revise extends ClassLoader {
	...
	public static void main(String[] args) throws Exception {
		TestCode16_Revise testCode16 = new TestCode16_Revise("loder1"); //设置为null，父类加载器为空
		//testCode16.setRootPath("D:\\develop\\CCXI\\DebugCodes\\bin\\");
		testCode16.setRootPath("D:\\test\\");
		...
		testCode1601.setRootPath("D:\\test\\");
